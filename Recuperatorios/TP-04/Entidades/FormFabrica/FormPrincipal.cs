...
namespace FormFabrica
{
    ...
    public partial class FormPrincipal : Form
    {
        ...
        private bool closed_form = false;
        AutoParte aux;
        ...
        /// <summary>
        /// Hilo para actualizar la cantidad de piezas.
        /// </summary>
        ...
        {
            dgvListMaterials.DataSource = fabrica.Materiales.ToList();
            dgvListPieces.DataSource = fabrica.AutoPartes.ToList();
        }
       ...
       private void btnCerrar_Click(object sender, EventArgs e)
        ...
        {
            DialogResult output = MessageBox.Show("¿Está seguro de salir?", "Salir", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
            ...
            if (output == DialogResult.Yes)
            {
                ...
                eventoImagenes -= this.MostrarImagen;
            ...
            try
            {
                if (fabrica.Materiales.Count != 0)
                {
                    ...
                    if (rta == DialogResult.OK)
                    {
                        ...
                        if (fabrica.Materiales.Count != 0) 
                        {
                            MessageBox.Show("Se importaron con exito los datos.", "WARNING", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        }
                    }
                }
                else
